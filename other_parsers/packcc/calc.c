...
static int pcc_refill_buffer(calc_context_t *ctx, int num) {
    int n, c;
...
static void pcc_action_add_0(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
...
static void pcc_action_add_1(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define l (*__pcc_in->data.leaf.values.buf[0])
#define r (*__pcc_in->data.leaf.values.buf[1])
...
static void pcc_action_add_2(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
...
static void pcc_action_mul_0(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define l (*__pcc_in->data.leaf.values.buf[0])
#define r (*__pcc_in->data.leaf.values.buf[1])
...
static void pcc_action_mul_1(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define l (*__pcc_in->data.leaf.values.buf[0])
#define r (*__pcc_in->data.leaf.values.buf[1])
...
static void pcc_action_mul_2(calc_context_t *__pcc_ctx, pcc_thunk_t *__pcc_in, pcc_value_t *__pcc_out) {
#define auxil (__pcc_ctx->auxil)
#define __ (*__pcc_out)
#define o (*__pcc_in->data.leaf.values.buf[2])
#define _0 pcc_get_capture_string(__pcc_ctx, &__pcc_in->data.leaf.capt0)
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_add(calc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_mul(calc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_term(calc_context_t *ctx);
static pcc_thunk_chunk_t *pcc_evaluate_rule_ws(calc_context_t *ctx);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_expression(calc_context_t *ctx) {
    ...
    pcc_value_table__resize(ctx->auxil, &chunk->values, 1);
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    if (!pcc_apply_rule(ctx, pcc_evaluate_rule_add, &chunk->thunks, &(chunk->values.buf[0]))) goto L0000;
    {
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_add(calc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    {
        const int p = ctx->pos;
        const int n = chunk->thunks.len;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_mul, &chunk->thunks, &(chunk->values.buf[0]))) goto L0002;
        if (
            pcc_refill_buffer(ctx, 1) < 1 ||
            ctx->buffer.buf[ctx->pos] != '+'
        ) goto L0002;
        ctx->pos++;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_add, &chunk->thunks, &(chunk->values.buf[1]))) goto L0002;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_add_0, 3, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
    ...
    L0002:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_mul, &chunk->thunks, &(chunk->values.buf[0]))) goto L0003;
        if (
            pcc_refill_buffer(ctx, 1) < 1 ||
            ctx->buffer.buf[ctx->pos] != '-'
        ) goto L0003;
        ctx->pos++;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_add, &chunk->thunks, &(chunk->values.buf[1]))) goto L0003;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_add_1, 3, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
    ...
    L0003:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_mul, &chunk->thunks, &(chunk->values.buf[2]))) goto L0004;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_add_2, 3, 0);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_mul(calc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 0);
    {
        ...
        ctx->pos++;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_mul, &chunk->thunks, &(chunk->values.buf[1]))) goto L0002;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_mul_0, 3, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
    ...
    L0002:;
        ...
        ctx->pos++;
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_mul, &chunk->thunks, &(chunk->values.buf[1]))) goto L0003;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_mul_1, 3, 0);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.values.buf[1] = &(chunk->values.buf[1]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
    ...
    L0003:;
        ctx->pos = p;
        pcc_thunk_array__revert(ctx->auxil, &chunk->thunks, n);
        if (!pcc_apply_rule(ctx, pcc_evaluate_rule_term, &chunk->thunks, &(chunk->values.buf[2]))) goto L0004;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_mul_2, 3, 0);
            thunk->data.leaf.values.buf[2] = &(chunk->values.buf[2]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
...
static pcc_thunk_chunk_t *pcc_evaluate_rule_term(calc_context_t *ctx) {
    ...
    pcc_capture_table__resize(ctx->auxil, &chunk->capts, 1);
    {
        ...
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_term_0, 1, 1);
    ...
    L0002:;
        ...
        ctx->pos++;
        {
            pcc_thunk_t *const thunk = pcc_thunk__create_leaf(ctx->auxil, pcc_action_term_1, 1, 1);
            thunk->data.leaf.values.buf[0] = &(chunk->values.buf[0]);
            thunk->data.leaf.capt0.range.start = chunk->pos;
            thunk->data.leaf.capt0.range.end = ctx->pos;
            pcc_thunk_array__add(ctx->auxil, &chunk->thunks, thunk);
